...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_irforum_test_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_irforum_test_default.inc';
}
// </DDSETTINGS>
...
//$config['acquia_search_solr.settings']['override_search_core'] = acquia_search_override_example_20210427();
$config['acquia_search.settings']['override_search_core'] = 'AGHX-142716.dev.irforum';
