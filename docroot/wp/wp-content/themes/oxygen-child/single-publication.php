					...
					<?php while ( have_posts() ) : the_post(); ?>
						...
						<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
							...
							<div class="post-content">
								...
								<?php if ( current_theme_supports( 'get-the-image' ) ) get_the_image( array( 'meta_key' => 'Thumbnail', 'size' => 'thumbnail', 'link_to_post' => false, 'image_class' => 'featured', 'attachment' => false, 'width' => 150, 'height' => 212 ) ); ?>
