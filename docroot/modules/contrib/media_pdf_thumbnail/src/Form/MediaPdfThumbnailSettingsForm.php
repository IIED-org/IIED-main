...
class MediaPdfThumbnailSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['uri'][self::DESTINATION_URI_PUBLIC] = [
      ...
      '#default_value' => $this->config('media_pdf_thumbnail.settings')->get(self::DESTINATION_URI_PUBLIC),
    ...
    $form['uri'][self::DESTINATION_URI_PRIVATE] = [
      ...
      '#default_value' => $this->config('media_pdf_thumbnail.settings')->get(self::DESTINATION_URI_PRIVATE),
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    $destinationUris = [self::DESTINATION_URI_PUBLIC => $form_state->getValue(self::DESTINATION_URI_PUBLIC), self::DESTINATION_URI_PRIVATE => $form_state->getValue(self::DESTINATION_URI_PRIVATE)];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config(self::CONFIG_NAME)->set(self::DESTINATION_URI_PUBLIC, $form_state->getValue(self::DESTINATION_URI_PUBLIC))->save();
    $this->config(self::CONFIG_NAME)->set(self::DESTINATION_URI_PRIVATE, $form_state->getValue(self::DESTINATION_URI_PRIVATE))->save();
