...
class CommonSettingsPageForm extends ConfigFormBase {
   ...
   */
  public function __construct(ConfigFactoryInterface $config_factory, MultipleRegistrationController $multipleRegistrationController, CacheBackendInterface $cacheBackend, RouteBuilderInterface $routerBuilder, TypedConfigManagerInterface $typed_configmanager) {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['enable_add_user_buttons_on_people_page'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Enable Add user buttons on People page'),
      '#description' => $this->t('Enables additional Add user buttons for roles with own registration page.'),
      '#default_value' => $config->get('enable_add_user_buttons_on_people_page'),
    ];
    ...
    switch ($clicked_button) {
      case 'save':
        ...
        $this->config('multiple_registration.common_settings_page_form_config')
          ...
          ->save();
        $this->config('multiple_registration.common_settings_page_form_config')
          ->set('enable_add_user_buttons_on_people_page', $form_state->getValue('enable_add_user_buttons_on_people_page'))
          ->save();
