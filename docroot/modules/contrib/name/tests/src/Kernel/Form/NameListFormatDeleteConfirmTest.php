 ...
 * @group name
 */
class NameListFormatDeleteConfirmTest extends KernelTestBase {
  ...
  public function testSubmitFormDeletesEntityAndRedirectsToList(): void {
    ...
    $entity = $storage->create([
      'id' => 'kernel_list_format_to_delete',
      'label' => 'To delete list',
    ]);
    $entity->save();

    /** @var \Drupal\Core\Entity\EntityFormInterface $form_object */
    $form_object = $this->container->get('entity_type.manager')
      ->getFormObject('name_list_format', 'delete');
    ...
    $this->assertNull(NameListFormat::load('kernel_list_format_to_delete'));
