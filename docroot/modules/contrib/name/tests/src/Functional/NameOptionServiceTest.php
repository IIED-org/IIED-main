...
/**
 * Tests NameOptionService class.
 *
 * @group name
 */
class NameOptionServiceTest extends NameTestBase {
  ...
  /**
   * Tests dashed custom placeholder maps to the '_none option key.
   */
  public function testTitleOptionsWithCustomDashedPlaceholder() {
    $field = $this->createNameField('field_name_test', 'entity_test', 'entity_test');
    $settings = $field->getSettings();
    $settings['title_options'] = [
