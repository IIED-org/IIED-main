...
class ServiceTest extends KernelServiceTestBase {
  ...
  public function testGet(): void {
    $this->initializeService();
    $this->assertInstanceOf(QueuerInterface::class, $this->service->get('a'));
    $this->assertInstanceOf(QueuerInterface::class, $this->service->get('b'));
    $this->assertFalse($this->service->get('c'));
    $this->service->setPluginsEnabled(['c']);
    $this->assertInstanceOf(QueuerInterface::class, $this->service->get('c'));
  }
