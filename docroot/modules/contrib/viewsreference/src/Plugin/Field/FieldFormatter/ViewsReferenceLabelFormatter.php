...
class ViewsReferenceLabelFormatter extends FormatterBase {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    $elements['link'] = [
      '#title' => $this->t('Link label to the referenced view'),
      '#type' => 'checkbox',
  ...
  public function settingsSummary() {
    $summary = [];
    $summary[] = $this->getSetting('link') ? $this->t('Link to the referenced view') : $this->t('No link');
    return $summary;
  }
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $display_exists = $view->setDisplay($display_id);
      if ($display_exists) {
