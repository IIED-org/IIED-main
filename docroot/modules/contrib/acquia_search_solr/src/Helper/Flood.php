...
class Flood {
  ...
  public static function getFloodDefaults() {
    return [
      'select' => ['window' => 10, 'limit' => 10],
      'update' => ['window' => 10, 'limit' => 5],
      'update/extract' => ['window' => 10, 'limit' => 5],
      'autocomplete' => ['window' => 10, 'limit' => 20],
  ...
  public static function getConfigValue(string $request_type, string $value_name) {
    ...
    return \Drupal::config('acquia_search_solr.settings')->get($config_id) ?? $defaults[$request_type][$value_name];
  }
  ...
  public static function isLoggingEnabled(): bool {
    return \Drupal::config('acquia_search_solr.settings')->get('flood_logging') ?? TRUE;
  }
  ...
  public static function logFloodLimit(string $request_type) {
    if (self::isLoggingEnabled()) {
      \Drupal::logger('acquia_search_solr')->warning(
