...
#[SearchApiProcessor(
  ...
  label: new TranslatableMarkup('Double Quote Workaround'),
  description: new TranslatableMarkup('Replaces double quotes in field values and query to work around a bug in Solr streaming expressions.'),
  stages: [
    'preprocess_index' => -15,
    'preprocess_query' => -15,
    'postprocess_query' => 0,
