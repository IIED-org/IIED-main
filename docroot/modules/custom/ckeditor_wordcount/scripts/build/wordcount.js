(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["CKEditor5"] = root["CKEditor5"] || {}, root["CKEditor5"]["wordcount"] = factory();
})(self, () => {
 ...
 * ```
 */
class WordCount extends delegated_corefrom_dll_reference_CKEditor5.Plugin {
    /**
     * @inheritDoc
     */
    constructor(editor) {
        ...
        this._wordsMatchRegExp = delegated_utilsfrom_dll_reference_CKEditor5.env.features.isRegExpUnicodePropertySupported ?
    ...
    get wordCountContainer() {
        ...
        const children = [];
        if (!this._outputView) {
            this._outputView = new delegated_uifrom_dll_reference_CKEditor5.View();
...
;// CONCATENATED MODULE: ./node_modules/@ckeditor/ckeditor5-word-count/src/index.js
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
;// CONCATENATED MODULE: ./scripts/ckeditor5_plugins/wordcount/src/status_view.js


class StatusView extends delegated_uifrom_dll_reference_CKEditor5.View {
...
;// CONCATENATED MODULE: ./scripts/ckeditor5_plugins/wordcount/src/index.js




class DrupalWordCount extends delegated_corefrom_dll_reference_CKEditor5.Plugin {
...
/* harmony default export */ const src = ({WordCount: WordCount,DrupalWordCount});
